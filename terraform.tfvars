...
vm_definitions = {
  ...
  "freeipa1"      = { cpus = 2, memory = 2048, ip = "10.17.3.17", type = "rocky" },
  "loadbalancer1" = { cpus = 2, memory = 2048, ip = "10.17.3.18", type = "rocky" },
  "postgres1"     = { cpus = 2, memory = 2048, ip = "10.17.3.20", type = "rocky" }
}
